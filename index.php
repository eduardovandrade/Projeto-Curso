<?php
    $nomeCurso1="FullStack";
    $decricaoCurso1="Curso de desenvolvimento web";
    $valorCurso1=1000.99;
  ...
  <div class="col-sm-6 col-md-4">
    <div class="thumbnail">
      ...
      <div class="caption">
        ...
        <p><?php echo $decricaoCurso1;?></p>
        <p><?php echo $valorCurso1?></p>
        <p><a href="#" class="btn btn-primary" role="button">Comprar</a> <a href="#" class="btn btn-default" role="button">Devolver</a></p>
      </div>
    </div>
  </div>
  <div class="col-sm-6 col-md-4">
